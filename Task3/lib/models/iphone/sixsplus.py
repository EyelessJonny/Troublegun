...
class Main:
    ...
    def __init__(self):
        print("iPhone 6S Plus Selected\n\n")
        self.error = "I'm sorry I didn't understand...\n\n"
        self.que = ("",
          "Is your iPhone 6S Plus under warranty? 'YES' or 'NO'\n> ",
          "Can your iPhone 6S Plus be powered on? 'YES' or 'NO'\n> ",
          "Have you turned your iPhone 6S Plus off and on again? 'YES' or 'NO'\n> ",
          "Has your iPhone 6S Plus's battery been charged? 'YES' or 'NO'\n> ",
          "Is your iPhone 6S Plus's exterior damaged? 'YES' or'NO'\n> ",
          "Is your iPhone 6S Plus wet? 'YES' or 'NO'\n> ",
          "Is your iPhone 6S Plus infected with malware? 'YES' or 'NO'\n> ",
          "Is your iPhone 6S Plus boot-looping? 'YES' or 'NO'\n> ")
        self.os = str
        self.warranty = str
        self.power = str
        self.exterior = str
